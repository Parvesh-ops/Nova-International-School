        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
          {cards.map((card, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-heading font-semibold text-primary mb-2 leading-6">
                {card.title}
              </h3>
